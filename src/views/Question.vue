      ...
      <el-row style="padding-left: 10px; height: 100%">
        ...
        <el-col :span="8" style="padding-top: 20px;">
          ...
          <el-tabs tab-position="left" style="padding-top: 20px; margin-left: -30px" v-model="subject">
            ...
            <el-tab-pane name="计算机组成原理">
              <template v-slot:label>
                <svg t="1702620971266" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12933" width="200" height="200"><path d="M321.931636 729.6h223.418182l8.610909 113.198545h-240.64l8.610909-113.198545z" fill="#1296db" p-id="12934"></path><path d="M243.176727 792.250182h70.144l-8.610909 59.159273h257.861818l-8.610909-59.159273h70.167273l25.832727 113.175273H217.344l25.832727-113.175273zM829.952 118.574545H37.329455a14.266182 14.266182 0 0 0-14.219637 14.219637v582.632727c0 7.819636 6.4 14.219636 14.219637 14.219636h173.847272v-0.046545h364.427637v0.046545h254.347636a14.266182 14.266182 0 0 0 14.219636-14.219636V132.794182a14.242909 14.242909 0 0 0-14.219636-14.219637z m-64.558545 500.224a14.266182 14.266182 0 0 1-14.219637 14.219637H116.107636a14.266182 14.266182 0 0 1-14.219636-14.219637V213.876364c0-7.819636 6.4-14.219636 14.219636-14.219637h635.066182c7.819636 0 14.219636 6.376727 14.219637 14.219637v404.922181zM994.885818 399.918545l-0.023273-0.023272-0.023272-0.023273a20.48 20.48 0 0 0-14.498909-6.027636h-99.211637a20.549818 20.549818 0 0 0-14.475636 6.004363l-0.023273 0.023273-0.023273 0.023273v0.023272a20.48 20.48 0 0 0-6.027636 14.475637v396.381091c0 5.632 2.304 10.728727 6.004364 14.475636l0.023272 0.023273 0.023273 0.023273a20.48 20.48 0 0 0 14.498909 6.027636h99.211637a20.549818 20.549818 0 0 0 14.475636-6.004364l0.023273-0.023272 0.023272-0.023273h0.023273a20.48 20.48 0 0 0 6.027637-14.498909V414.417455a20.712727 20.712727 0 0 0-6.027637-14.49891z m-7.866182 410.856728a6.656 6.656 0 0 1-1.931636 4.701091l-0.023273 0.023272a6.656 6.656 0 0 1-4.701091 1.931637h-99.211636a6.656 6.656 0 0 1-4.701091-1.931637l-0.023273-0.023272a6.656 6.656 0 0 1-1.931636-4.701091V414.394182c0-1.838545 0.744727-3.514182 1.931636-4.701091l0.023273-0.023273a6.656 6.656 0 0 1 4.701091-1.931636h99.211636c1.838545 0 3.514182 0.744727 4.701091 1.931636l0.023273 0.023273a6.656 6.656 0 0 1 1.931636 4.701091v396.381091z" fill="#1296db" p-id="12935"></path><path d="M900.817455 452.608h59.857454v12.893091h-59.857454v-12.893091zM900.817455 497.943273h59.857454v12.893091h-59.857454v-12.893091z" fill="#1296db" p-id="12936"></path><path d="M880.64 414.836364v397.288727h100.189091V414.836364H880.64z m79.104 380.229818h-55.784727v-36.514909h55.784727v36.514909z m5.888-312.552727v34.39709H895.837091v-36.887272H965.632v2.490182z m0-45.312v34.39709H895.837091v-36.887272H965.632v2.490182z" fill="#1296db" p-id="12937"></path><path d="M931.584 788.805818a12.288 12.288 0 1 0 0-24.576 12.288 12.288 0 0 0 0 24.576z" fill="#1296db" p-id="12938"></path></svg>
                计算机组成原理
              </template>
              <div>
              <el-tabs class="el-tabs-modify" tab-position="left" v-model="knowledge_1" style="float: right; margin-right: 50px;">
                ...
                <el-tab-pane label="指令系统" name="指令系统"></el-tab-pane>
                <el-tab-pane label="中央处理器" name="中央处理器"></el-tab-pane>
              </el-tabs>
              </div>
            </el-tab-pane>

            <el-tab-pane name="计算机网络">
              <template v-slot:label>
        ...
        <div style="background-color: white; overflow-y: auto; height: 100%; border-radius: 0px 10px 10px 0px; border-left: 1.5px solid #dedede;">
          <div id="question">
            <svg style="width: 32px; height: 32px; margin-top: 8px" t="1702676593953" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10962" width="200" height="200"><path d="M717.12 274H762c82.842 0 150 67.158 150 150v200c0 82.842-67.158 150-150 150H262c-82.842 0-150-67.158-150-150V424c0-82.842 67.158-150 150-150h44.88l-18.268-109.602c-4.086-24.514 12.476-47.7 36.99-51.786 24.514-4.086 47.7 12.476 51.786 36.99l20 120c0.246 1.472 0.416 2.94 0.516 4.398h228.192c0.1-1.46 0.27-2.926 0.516-4.398l20-120c4.086-24.514 27.272-41.076 51.786-36.99 24.514 4.086 41.076 27.272 36.99 51.786L717.12 274zM262 364c-33.138 0-60 26.862-60 60v200c0 33.138 26.862 60 60 60h500c33.138 0 60-26.862 60-60V424c0-33.138-26.862-60-60-60H262z m50 548c-24.852 0-45-20.148-45-45S287.148 822 312 822h400c24.852 0 45 20.148 45 45S736.852 912 712 912H312z m-4-428c0-24.852 20.148-45 45-45S398 459.148 398 484v40c0 24.852-20.148 45-45 45S308 548.852 308 524v-40z m318 0c0-24.852 20.148-45 45-45S716 459.148 716 484v40c0 24.852-20.148 45-45 45S626 548.852 626 524v-40z" fill="#444444" p-id="10963"></path></svg>
              <div class="info">
                <p class="info-content"><span>Hi，我是在线问答机器人，请选择左边的课程和知识点👈，我将根据您的选择进行出题。准备好后点击下方的 “开始问答” 吧🤗！</span></p>
              </div>
            </div>
          <div v-for="(item, index) in questionList" :key="index">
            ...
            <div id="question" v-show="optionList[index]">
              <svg style="width: 32px; height: 32px; margin-top: 8px" t="1702676593953" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10962" width="200" height="200"><path d="M717.12 274H762c82.842 0 150 67.158 150 150v200c0 82.842-67.158 150-150 150H262c-82.842 0-150-67.158-150-150V424c0-82.842 67.158-150 150-150h44.88l-18.268-109.602c-4.086-24.514 12.476-47.7 36.99-51.786 24.514-4.086 47.7 12.476 51.786 36.99l20 120c0.246 1.472 0.416 2.94 0.516 4.398h228.192c0.1-1.46 0.27-2.926 0.516-4.398l20-120c4.086-24.514 27.272-41.076 51.786-36.99 24.514 4.086 41.076 27.272 36.99 51.786L717.12 274zM262 364c-33.138 0-60 26.862-60 60v200c0 33.138 26.862 60 60 60h500c33.138 0 60-26.862 60-60V424c0-33.138-26.862-60-60-60H262z m50 548c-24.852 0-45-20.148-45-45S287.148 822 312 822h400c24.852 0 45 20.148 45 45S736.852 912 712 912H312z m-4-428c0-24.852 20.148-45 45-45S398 459.148 398 484v40c0 24.852-20.148 45-45 45S308 548.852 308 524v-40z m318 0c0-24.852 20.148-45 45-45S716 459.148 716 484v40c0 24.852-20.148 45-45 45S626 548.852 626 524v-40z" fill="#444444" p-id="10963"></path></svg>
              <div class="info">
...
export default({
  ...
  methods: {
    ...
    getQuestion(i) {
      ...
      switch (this.subject) {
        case '计算机组成原理':
          knowledge = this.knowledge_1
          break
        case '计算机网络':
          knowledge = this.knowledge_2
          break
        case '操作系统':
          knowledge = this.knowledge_3
          break
        case '数据结构':
          knowledge = this.knowledge_4
          break
      }
